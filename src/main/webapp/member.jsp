    ...
    <div class="w">
        ...
        <div class="person-header-right fr">
            <ul>
                ...
                <li class="user_head">
                    <a href="person?actionName=projectJoin&pageNav=user_manage.jsp&pageNum=1"><img src="user?actionName=userHead&imageName"  style="width: 25px;height: 25px; border-radius: 50%;"></a>
    ...
    <div class="container-fluid">
        <div class="container type">
            ...
            <div class="type_img_position">
                <img class="type_img" style="display: inline-block;" src="./projectImg/${project.projectImg}" alt="">
            </div>
            <!-- 图片end -->
...
<div class="result_main container">
    <h2>成员列表</h2>
    <ul>
        <c:forEach var="member" items="${memberPage.getDataList()}">
            <li class="member_simple">
                <div class="member_img">
                    <img src="./userImg/${member.memberHead}" class="img-circle">
                </div>
                <div class="member_main">
                    <div class="member_name">
                        <div>名字: ${member.userName}</div>
                    </div>
                    <div class="member_ziwu">
