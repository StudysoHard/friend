                        ...
                        <div class="carousel-inner" role="listbox" id="submit_style" style="position: relative;height: 135px;margin-top: 50px;">
                            <c:forEach items="${requestList}" var="list">
                                    <div class="item <c:if test="${list.requestId == first}">active</c:if>">
                                        <img src="./static/image/head02.png">
                                        <div class="userName">
                                            ${list.userName}
                                        </div>
                                        <div class="userSex">
                                        ...
                                        <div class="join_project">
                                            ...
                                            <a href="javascript:;" data-toggle="modal" data-target="#showElseContent">
                                                查看他的申请
                                            </a>
                                        </div>
                                    </div>
                                <%--                                            点击之后的模态弹出框--%>
                                <div class="modal fade" id="showElseContent" tabindex="-1" role="dialog" aria-labelledby="showElseContent">
                                        ...
                                        <div class="modal-content">
                                            <form action="project" id="write_content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <input type="button" class="btn" value="同意">
                                ...
                                <ol id="button_ol" class="carousel-indicators" style="position: relative;">
                                    <c:forEach begin="0" end="${count-1}" var="num">
            ...
            <div class="content-button"><span class="change_font glyphicon glyphicon-hand-down real_font"></span></div>
                <div class="contentbar fl">
                    <ul>
                        ...
                        <li>
                            <span style="transition: all 1s;" class="glyphicon glyphicon-hdd"></span>
                            <a href="person?actionName=projectJoin&pageNav=user_resouce.jsp&pageNum=1">我加入的</a>
                        </li>

                        <li>
                            <span style="transition: all 1s;" class="glyphicon glyphicon-search"></span><a href="#">我的信息</a>
                        </li>

                        <li>
                            <span class="glyphicon glyphicon-send"></span>
                            <a href="person?actionName=showMyProject&pageNav=user_manage.jsp&pageNum=1">我创建的</a>
                        </li>
                        <li>
                            <span style="transition: all 1s;" class="glyphicon glyphicon-cog"></span>
                            <a href="person?actionName=movePage&pageNav=user_information.jsp">个人设置</a>
                        </li>
                        <hr style="background-color: #e5e5e5;">

                        <li>
                            <span style="transition: all 1s;" class="glyphicon glyphicon-plus"></span>
                            <a href="person?actionName=movePage&pageNav=create_project.jsp">创建项目</a>
                        </li>

                        <li>
                            <span style="transition: all 1s;" class="glyphicon glyphicon-thumbs-up"></span>
                            <a href="person?actionName=movePage&pageNav=user_privacy.jsp">关于隐私</a>
                        </li>

                        <li>
                            <span style="transition: all 1s;" class="glyphicon glyphicon-off"></span>
                            <a href="person?actionName=movePage&pageNav=sure_move.jsp">注销用户</a>
                        </li>
                    </ul>
                </div>
            <c:if test="${empty changePage}">
                <c:import url="person/user_resouce.jsp"></c:import>
            </c:if>
            <c:if test="${!empty changePage}">
