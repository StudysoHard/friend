...
<%--                    头像下方的hover --%>
    ...
    <!-- 右侧的快速匹配 -->
    <button class="fast_style toggele_button btn" style="position: fixed;right: 10vh;top: 80vh;">快速匹配</button>
    <!-- 快速匹配end -->
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <c:if test="${!empty indexType1}">
                                ...
                                <div class="content">
                                    <div class="media">
                                        <div class="media-left">
                                            <a href="type?actionName=showAllProject&typeName=${indexType1.typeName}">
                                                <img class="media-object" src="./static/image/${indexType1.typeImg}" alt="...">
                                            </a>
                                        </div>
                        ...
                        <div class="border_flex" style="padding-top: 15px;">
                            <div class="card">
                                ...
                                <div class="content">
                                    <div class="media">
                                        <div class="media-left">
                                            <a href="type?actionName=showAllProject&typeName=${indexType2.typeName}">
                                                <img class="media-object" src="./static/image/${indexType2.typeImg}" alt="...">
                                            </a>
                                        </div>
                                        <div class="media-body main_element">
                ...
                <!--  第三列-->
                <div class="col-lg-4">
                    <c:forEach items="${indexType3}" var="indexType3">
                        <div class="border_flex" style="padding-top: 15px;">
                            <div class="card">
                                <span></span><span></span><span></span><span></span>
                                <div class="content">
                                    <div class="media">
                                        <div class="media-left">
                                            <a href="type?actionName=showAllProject&typeName=${indexType3.typeName}">
                                                <img class="media-object" src="./static/image/${indexType3.typeImg}" alt="...">
                                            </a>
                                        </div>
                                        <div class="media-body main_element">
                                            <h4 class="media-heading"><a href="#">${indexType3.typeName}</a></h4>
                                                ${indexType3.typeHead}
                                        </div>
                                    </div>
                                </div>
                    ...
                    <c:forEach items="${indexProject1}" var="indexProject1">
                        <div class="col-lg-3">
                            <a href="project?projectId=${indexProject1.projectId}&actionName=showresource">
                                <div class="thumbnail">
                                    <img src="./static/image/${indexProject1.projectImg}">
                                    <div class="caption">
                ...
                <c:forEach items="${indexProject2}" var="indexProject2">
                    <div class="col-lg-3">
                        <a href="project?projectId=${indexProject2.projectId}&actionName=showresource">
                            <div class="thumbnail">
                                <img src="./static/image/${indexProject2.projectImg}" alt="...">
                                <div class="caption">
